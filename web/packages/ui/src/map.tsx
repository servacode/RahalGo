  ...
  return (
    <div>
      ...
      <button
        ...
        onClick={locateMe}
        disabled={locating}
        className="mb-2 flex w-full items-center justify-center gap-2 rounded-control bg-accent px-4 py-2.5 text-sm font-bold text-on-accent elev-1 transition-colors hover:bg-accent-dark disabled:opacity-60"
      >
