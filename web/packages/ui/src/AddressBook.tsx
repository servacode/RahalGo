            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {/* ══════════════════════════════════════════════════
                      **والعنوانُ يُقرأ كاملاً — وهو ما يُوصَل إليه**
                      ══════════════════════════════════════════════════

                      (شهده المالك ٢٠٢٦-٠٨-١١: «العنوانُ مقصوصٌ وناقصٌ ما
                       يظهر بشكلٍ كامل».)

                      **كان `truncate` — سطرٌ واحدٌ وما زاد نقاطٌ ثلاث.**
                      وعنوانُ الرقّة وصفٌ لا رقم: «شارع الكهربا جانب مغسلة
                      أبو…» — **فيُقصّ عند أنفع ما فيه**، وهو العلامةُ التي
                      يعرفها السائق.

                      **ومن لا يقرأ عنوانَه لا يعرف أيُّ عنوانٍ هو** حين
                      يكون له اثنان في الحيّ نفسِه.

                      **وثلاثةُ أسطرٍ سقفاً** — تكفي أطولَ وصفٍ ولا تجعل
                      البطاقةَ عموداً. */}
                  <p className="line-clamp-3 text-xs text-ink-muted">{a.address_text}</p>
                </div>
