            ...
            <section key={g.day}>
              ...
              {/* ══════════════════════════════════════════════════════
                  ...
                  **والترتيبُ الزمنيُّ يبقى مفهوماً** لأنّ اليومَ مجموعٌ فوقها
                  ...
                  # والعرضُ مقصودٌ لا عددُ الأعمدة

                  **ثلاثةُ أعمدةٍ ثابتةٍ أعطت ٦٢٥ بكسلاً للبطاقة عند ١٩٢٠**
                  ومحتواها مئةٌ وخمسون — **ففجوةٌ من أربعمئة داخل كلّ بطاقة.**
                  **نُقل العيبُ من الصفحة إلى البطاقة ولم يُزل.**

                  **وهو عينُ ما وقع في شبكة الأصناف**: العددُ الثابتُ يكبر مع
                  الشاشة بلا حدّ. **فالقرارُ عرضُ البطاقة والشبكةُ تحسب العدد.**

                  **والحدُّ الأدنى ٣٠٤ بكسلاً** — اختير ليُعطي ستّةً في السطر
                  على شاشة المالك (قرارُه ٢٠٢٦-٠٨-٠٦: «اجعلها ٦ بكلّ سطر»)،
                  **ويتقلّص وحدَه على ما دونها:**
                  ...
                  **ولا يُكتب «ستّةُ أعمدة» عدداً**: على جوّالٍ بثلاثمئةٍ تصير
                  ستُّ بطاقاتٍ بخمسين بكسلاً — **ورقمٌ يصلح لشاشةٍ واحدةٍ
                  يكسر ما عداها.** */}
