      ...
      {filters.length > 1 && (
        ...
        /* **والصفُّ صار مركزيّاً** (`Chips`) — كان هنا بمقاسٍ، وفي حسابات
           ...
           **ولا رقمَ في الحبّة** (قرارُ المالك ٢٠٢٦-٠٨-٠٦: «ظهورُ الأرقام
           ...
           كم بقي لا كم يوجد.** */
        /* **وتلتفُّ ولا تنزلق** — (قرارُ المالك ٢٠٢٦-٠٨-١١: «الإشعاراتُ يجب
           أن تأخذ كلَّ الحالات ولا يكون هناك سكرولٌ أو سحب»).

           **والانزلاقُ يُخفي ما لا يُظنّ موجوداً**: من رأى أربعَ حبّاتٍ لم
           يعلم أنّ خلفها ثلاثاً، **فيظنّ أنّ المنصّةَ لا ترشّح إلّا بها.**

           **وكان الالتفافُ مرفوضاً لأنّه يرفع الرأسَ** فيدفع أوّلَ إشعارٍ
           تحت الطيّة — **وقرارُ المالك يسبق ذلك**، والحبّاتُ صارت أصغرَ
           على الجوّال فقلّ ما تأخذه من ارتفاع. */
        <Chips items={filters} value={kind} onChange={setKind} wrap />
      )}
