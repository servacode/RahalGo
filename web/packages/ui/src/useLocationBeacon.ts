 ...
 * @param everyMs كم بين نبضةٍ وأخرى — **من `drivers.location_ping_sec`.**
 *
 * **والستّون هنا احتياطيٌّ لا حدّ**: تعمل به الشاشةُ قبل أن يصل الإعداد،
 * **ومقايضةُ البطّاريّة بدقّة التوزيع قرارُ مالكٍ لا قرارُ مبرمج** — أسرعُ
 * يعني توزيعاً أدقَّ وبطّاريّةً تنفد قبل نهاية الدوام، وأبطأُ يعني سائقاً
 * يُحسب في مكانٍ غادره. (جردُ لوحة السائق ٢٠٢٦-٠٨-٠٩.)
 */
