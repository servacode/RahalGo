  ...
  return (
    ...
    */
    <header
      ...
      */
      /*
        **ولا حشوةَ ولا زوايا** — (قرارُ المالك ٢٠٢٦-٠٨-٠٦.)

        كان لوحاً عائماً بزوايا عشرين وحشوةٍ من الجانبين، **فيصير صندوقاً
        ثانياً فوق صندوق**: الصفحةُ تحتَه محشوّةٌ أصلاً من الغلاف الخارجيّ.

        **والصفُّ صار يحاذي ما تحته**: الشعارُ على استقامة أوّل بطاقةٍ في
        الشبكة، **والعينُ تقرأ عموداً واحداً لا حافّتين متداخلتين.**
      */
      className={`surface-lit mb-3 flex items-center gap-2 bg-surface sm:gap-3 ${
