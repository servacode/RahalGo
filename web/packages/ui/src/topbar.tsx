...
export function AppDownloadChip({ label }: { label: string }) {
  ...
  /* ══════════════════════════════════════════════════════════════════
     **ولا تُرسَم إلّا بعد أن يركب المتصفّحُ الصفحة.**
     ══════════════════════════════════════════════════════════════════

     (كشفه فحصٌ شاملٌ ٢٠٢٦-٠٨-٠٨: اثنتا عشرةَ صفحةً في تطبيق الزبون تردّ
      «Hydration failed» — **وأنا سبّبتُها يومَ أضفتُ هذه الحبّة.**)

     قِيس: الخادمُ يرسم ثلاثةَ روابطَ في الشريط والمتصفّحُ يرسم أربعة —
     **فالوجهةُ تصل العميلَ ولا تصل رسمَ الخادم**، فيختلف الرسمان.

     **وردُّ ريأكت أن يرمي الشجرةَ كلَّها ويعيد رسمها**: ومضةٌ في كلّ فتحةِ
     صفحة، وخطأٌ في كلّ جلسة.

     **والحلُّ ألّا يُرسَم شيءٌ حتّى يتّفقا**: الخادمُ لا يرسمها والعميلُ
     كذلك في أوّل رسم، ثمّ تظهر. **وزرُّ تحميلٍ يتأخّر ومضةً أهونُ من شجرةٍ
     تُرمى كلُّها.**
     ══════════════════════════════════════════════════════════════════ */
