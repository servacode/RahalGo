...
export {
  ...
  // **ورقةُ الفاتورة — لا سجلُّ الطلبات.**
  //
  // `IconOrder` هي `ReceiptText` وتعني «الطلبات» في كلّ لوحة —
  // **ولو استُعملت لبابِ الفاتورة لَقُرئت «افتح الطلبات» في ترويسة
  // طلب.** والفاتورةُ ورقةٌ تُطبع، **و`FileText` تقولها بلا لبس.**
  FileText as IconInvoice,
