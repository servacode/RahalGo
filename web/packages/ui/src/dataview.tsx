...
export function DataView<T>({
  ...
  if (view === "cards") {
    ...
    return (
      /* ══════════════════════════════════════════════════════════
         **والبطاقةُ ذاتُ العمود تأخذ عرضاً أوسع**
         ══════════════════════════════════════════════════════════

         (قرارُ المالك ٢٠٢٦-٠٨-١٣: «خلّيها ٣ حاليّاً، وإذا شفنا ما
          تغيّر شي نراجعها ٤».)

         **والعمودُ الجانبيُّ يأكل ستّةً وتسعين بكسلاً** من كلّ بطاقة.
         وأربعٌ في الصفّ تترك للمحتوى نحوَ مئةٍ وخمسين — **فيلتفّ
         «أبو لطيف ‎+963985395131» سطرين، وكذلك المتجرُ وسطورُ
         الفاتورة**، فتطول البطاقةُ وتتفاوت.

         **والقاعدةُ هنا لا في الشاشة**: من علّق عموداً جانبيّاً ورث
         العرضَ الأوسع — **ولا يُضبط رقمٌ في كلّ قسمٍ على حدة** فيفترق
         قسمان بلا سبب.

         **ومن لا عمودَ له يبقى على أربع** — لا شيءَ يأكل عرضَه. */
      <div
        className={`grid grid-cols-1 gap-4 sm:grid-cols-2 ${
          rail ? "xl:grid-cols-3" : "lg:grid-cols-3 xl:grid-cols-4"
        }`}
      >
        {items.map((item) => {
