              ...
              >
                ...
                **وما زاد على اثنتين يلتفّ** ولا يزاحم. */}
                  ...
                  **والأوّليّةُ الوحيدةُ تأخذ السطرَ كلَّه**
                  ...
                  (سأل المالك خمسَ مرّاتٍ ٢٠٢٦-٠٨-١٢: «رقم الطلب خلّيه
                   أقصى اليسار» — وكان يبقى في مكانه.)

                  **والسببُ هنا لا في الشاشة**: الصندوقُ حول الأوّليّة
                  **يتقلّص إلى عرض محتواه**، فمهما وُزّع ما فيه يمينا
                  ويسارا **لا فراغَ بينهما يُوزَّع.**

                  **و`justify-between` في الأب توزّع الأوّليّاتِ لا ما
                  بداخلها** — فإن كانت واحدةً لصقت بأوّل السطر.
                ...
                **والفراغُ يقع تحت البطاقة لا في وسطها**
                ...
                (سأل المالك ٢٠٢٦-٠٨-١٢: «المتجر فيه بادينغ واختلافٌ في
                 الشكل، في سببٌ وراء أنّ من الأسفل في فراغ — اكتشف
                 السبب».)

                **وكانت `flex-1` هنا**: قائمةُ الحقول تتمدّد لتملأ ارتفاع
                البطاقة. **وبطاقاتُ الصفّ الواحد تتساوى بأطولها** — فمن
                فاتورتُه سطرٌ واحدٌ يتمدّد فراغُه **بين «المتجر»
                و«الفاتورة»** بقدر ما زاد جارُه.

                **فيختلف الشكلُ من بطاقةٍ إلى جارتها** بلا سببٍ يُرى —
                وهو ما رآه المالك.
