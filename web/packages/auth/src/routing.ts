...
/**
 * هل يحمل أصحابُ الأدوار الميدانية دورَ الزبون أيضاً؟
 *
 * **مُطفأةٌ مؤقّتاً بقرار المالك (٢٠٢٦-٠٨-٠١) لأجل التجربة** — ومرآةٌ لثابت
 * الخادم `identity.FieldRolesAreCustomers`. حين يحمل السائقُ دورَ الزبون
 * يستطيع أن يطلب طلباً ثم يوصّله بنفسه، فتختلط الأطراف في تجربةٍ يُراد منها
 * أن تفصلها.
 *
 * وعليها يتوقّف زرّ «تسوّق» في اللوحات: بلا دور الزبون يصل صاحبُه إلى الموقع
 * فيتصفّح ولا يستطيع أن يطلب. **وزرٌّ يقود إلى بابٍ لا يُفتح أسوأ من غيابه** —
 * من غاب زرُّه يعرف أنه لا يملك الأمر، ومن تبعه ظنّ أن النظام انكسر.
 *
 * الطرفان يعودان معاً بسطرٍ في كلٍّ منهما.
 */
export const FIELD_ROLES_ARE_CUSTOMERS = false;
