  ...
  return (
    /* ══════════════════════════════════════════════════════════════════
       ...
       **والخلفيّةُ المتدرّجةُ تُنافس النموذج**: ثلاثُ طبقاتٍ ملوّنةٍ خلف
       ...
       ══════════════════════════════════════════════════════════════════ */
    /* ══════════════════════════════════════════════════════════════════
       **والبطاقةُ إلى جهة القراءة على المتّسع — لا في وسط الصورة**
       ══════════════════════════════════════════════════════════════════

       (قرارُ المالك ٢٠٢٦-٠٨-٠٧: «اجعل الفورمَ على اليمين ليكون متناسباً مع
        الصورة بشكلٍ أنيقٍ وجميل».)

       **صورةُ الخلفيّة ليست نقشاً متكرّراً** — فيها موضوعٌ يقف في جهة،
       **وبطاقةٌ في الوسط تجلس فوقه فتحجب ما رُفعت الصورةُ لأجله.**

       **والجهةُ جهةُ القراءة** (`justify-start` — يمينٌ في العربيّة): العينُ
       تبدأ هناك، **فتقع البطاقةُ حيث تنظر أوّلاً ويبقى المتّسعُ للصورة.**
    ...
    <div className="relative flex flex-1 items-center justify-center p-3 sm:p-6 lg:justify-start lg:ps-[7vw]">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="overflow-hidden surface elev-2">
          {/* ---------- جانب النموذج ---------- */}
          {/* **والمفتاحُ هو الوضع** — فتُهدم العقدةُ وتُبنى عند كلّ تبديل،
              **وبلاه لا تُعاد الحركةُ أبداً** لأنّ العنصرَ نفسَه باقٍ.
              (طلبُ المالك ٢٠٢٦-٠٨-٠٧: «تأثيرٌ بصريٌّ جميلٌ للانتقال».) */}
          <div
            key={mode}
            className="p-6 sm:p-8 lg:p-10 motion-safe:animate-[rahalgo-auth-swap_260ms_ease-out]"
          >
            ...
            <div className="mb-6 text-center">
              ...
              {/* **وقرصٌ أبيضُ حولَ الشعار** — (طلبُ المالك ٢٠٢٦-٠٨-١٧: «الدائرةُ
                  البيضاءُ رجّعها على التوب بار حول اللوغو أيضاً، وبشاشة تسجيل
                  الدخول والسايدبار»).

                  **وشاشةُ الدخول تقف على صورةٍ يرفعها صاحبُها** — **وشعارٌ
                  عارٍ على صورةٍ مزدحمةٍ يذوب فيها**، والقرصُ يفصله عنها. */}
              <BrandMark size={128} disc className="mx-auto mb-5" />
              {head.title && (
