    ...
    <TopBar start={brand} sticky>
      {logged ? (
        <TopBarActions
          ...
          active={pathname}
          /* **ولوحتي في القائمة أيضاً — فوق تسجيل الخروج.**

             (قرارُ المالك ٢٠٢٦-٠٨-١٠: «لوحتي تظهر برأيي بالقائمة المنسدلة
              أيضاً فوق تسجيل الخروج».)

             **والشريطُ يضيق على الجوّال فتُخفى كلمتُه** — تبقى أيقونةٌ
             تُقرأ بالتخمين. **والقائمةُ هي حيث يُبحث عمّا لا يُرى**، وآخرُ
             بندٍ فيها ملاصقٌ للخروج: **موضعُ «اخرج من هنا» بابين.**

             **ولا يظهر لزبونٍ لا لوحةَ له** — بندٌ يفتح فراغاً يُقرأ عطباً. */
          menu={
            portal
              ? [
                  ...MENU,
