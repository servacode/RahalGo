    ...
    <>
      <Link href="/" className="flex items-center gap-2">
        ...
        <BrandMark
          ...
          heightClass="h-8 sm:h-20"
          /* **وقرصٌ أبيضُ حولَه في الموقع وحدَه** — (طلبُ المالك
             ٢٠٢٦-٠٨-١٧). **واللوحاتُ الخمسُ لا تأخذه**: الافتراضُ بلا
             قرص، **وقرصٌ أبيضُ في سايدبارٍ داكنٍ لطخة.** */
          disc
