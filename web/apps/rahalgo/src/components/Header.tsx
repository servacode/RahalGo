          ...
          extras={
            <>
              ...
              <TopBarLink
                ...
                /* ══════════════════════════════════════════════════════
                   **وبابٌ واحدٌ لا بابان في شاشةٍ واحدة**
                   ══════════════════════════════════════════════════════

                   (قرارُ المالك ٢٠٢٦-٠٨-١١: «الطلبُ الخاصُّ حطّيتُه
                    بالأسفل بس أيقونتُه ما زالت بالتوب بار — هذا غلط،
                    خلص واحدٌ يكفي».)

                   **ونزل إلى الشريط السفليّ** (٢٠٢٦-٠٨-١١) — **وهو
                   للجوّال وحدَه** (`md:hidden`). فبقي في الشريطين معاً
                   على الهاتف، **ومدخلان لبابٍ واحدٍ في شاشةٍ ضيّقةٍ
                   يزاحمان ما لا بديلَ له.**

                   **ويبقى فوق الحاسوب** — لا شريطَ سفليَّ هناك،
                   **وحذفُه من الاثنين يقفل الباب.** */
                className="hidden md:flex"
              >
