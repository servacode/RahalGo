  ...
  return (
    ...
    <div>
      ...
      {typing ? (
        ...
        /* ══════════════════════════════════════════════════════════════
           **وسوقٌ لم يُفتح بعد يُقال، لا يُعرض فارغاً**
           ══════════════════════════════════════════════════════════════

           (قرارُ المالك ٢٠٢٦-٠٨-١١: «يجب أن يقول مثلاً قريباً يتمّ تفعيلُ
            المتاجر أو السوق، لأنّه ما يزال لا يوجد أيُّ متجرٍ ومنتجات».)

           **وشريطُ أقسامٍ كلُّها أصفارٌ يُقرأ عطباً**: الزبونُ يضغط قسماً
           فيجد «لا أصناف»، ثمّ ثانياً فثالثاً — **فيظنّ المنصّةَ مكسورةً
           لا فارغة.**

           **والفرقُ بين «لا يوجد الآن» و«معطوب» هو الفرقُ بين أن يعود
           غداً وألّا يعود.**

           **وتُقاس بالمجموع لا بقسمٍ واحد**: قسمٌ فارغٌ في سوقٍ عامرٍ حالٌ
           عاديّةٌ ورسالتُها غيرُ هذه. */
        <div className="mt-5">
          <EmptyState
            icon={<IconStore size={28} />}
            title={m.site.sections.soonTitle}
            action={<p className="text-sm text-ink-muted">{m.site.sections.soonBody}</p>}
          />
        </div>
      ) : (
        <>
