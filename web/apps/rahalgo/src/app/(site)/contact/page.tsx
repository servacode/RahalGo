  ...
  return (
    <PageContainer>
      ...
      {bare ? (
        ...
        /* ══════════════════════════════════════════════════════════
            **والمحتوى يتوسّط الصفحة بفجوةٍ على جانبيه**
            ══════════════════════════════════════════════════════════

            (طلبُ المالك ٢٠٢٦-٠٨-١٧: «خلّي بادينغ يمين ويسار والمحتوى
             يتوسّط الصفحة».)

            **وكان يمتدّ بعرض الشاشة كلِّه** — **وثلاثةُ ألواحٍ ممدودةٍ
            على ألفٍ وتسعمئةٍ تُقرأ صفحةً فارغةً فيها كلام.**

            **والفجوةُ تتدرّج مع العرض** كفجوة لافتة الواجهة، فلا يفترق
            هامشان في موقعٍ واحد. */
        <div className="banner-gutter mx-auto w-full max-w-3xl space-y-4">
          {WAYS.length > 0 && (
