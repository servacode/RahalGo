...
export default function PortalRedirect() {
  ...
  useEffect(() => {
    // ══════════════════════════════════════════════════════════════
    // **ولا يُحوَّل قبل وصول القدرات** (`WEBA`، ٢٠٢٦-٠٩-١٣)
    // ══════════════════════════════════════════════════════════════
    //
    // **والقرارُ صار بالقدرة** — **ولو حُوِّل قبل وصولها لَقُرئ صاحبُ
    // القدرةِ بلا قدرةٍ فسيق إلى `/app`**، وهو العطبُ الذي أُصلح.
    //
    // **وشبكةُ الأمان لا تكفي هنا**: هي للأسماء القديمة، **والرصدُ
    // ليس فيها.**
