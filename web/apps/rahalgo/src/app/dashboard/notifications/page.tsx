 ...
 * إلى قسمٍ لحاله».) وموضعُه الآن تبويبُ «إعلان المنصّة» في `/dashboard/settings`
 * (نُقل إليها ٢٠٢٦-٠٨-٠٨). **وكان هذا السطرُ يشير إلى
 * `/dashboard/broadcast` ولا صفحةَ بهذا الاسم** — قِيس ٢٠٢٦-٠٨-٢٣.
 */
