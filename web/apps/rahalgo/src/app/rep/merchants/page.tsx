              ...
              <EntityCard
                ...
                media={
                  logo ? (
                    ...
                    <img src={logo} alt="" loading="lazy" className="h-12 w-12 rounded-control object-contain" />
                  ) : (
                ...
                actions={
                  <>
                    <Link
                      href={`/rep/merchants/${mr.id}`}
                      className="flex flex-1 items-center justify-center gap-1.5 rounded-control bg-accent px-3 py-1.5 text-sm font-medium text-on-bright transition-opacity hover:opacity-90"
                    >
                      <IconView size={15} />
