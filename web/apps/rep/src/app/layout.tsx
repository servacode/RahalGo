...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = withPlatform(m.rep.appTitle, name);
  const description = withPlatform(m.rep.appDescription, name);
  return {
...
const SITE = process.env.NEXT_PUBLIC_SITE_URL ?? "http://localhost:3004";
