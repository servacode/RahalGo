...
class NavigationSession(
    ...
    private fun consume(fix: NavFix) {
        ...
        //  حصل وأينما ذهب».)
        //
        // **وكانت شاشةُ الرحلة تنقلها**: تقرأ [nav] وتنادي
        // `VoiceOrchestrator.offer`. **فإذا فُتح تبويبٌ آخرُ خرجت
        // الشاشةُ من التركيب وانقطع الناقل** — والجلسةُ تعمل والمحرّكُ
        // يولّد تعليماتٍ **ولا أحدَ يقولها.**
        //
        // **وما يجب أن يعمل والشاشةُ مطويّةٌ لا يُعلَّق بالشاشة.**
        onNav?.invoke(out)
