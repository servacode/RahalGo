            ...
            Box(
                ...
                when {
                    ...
                    tab == Tab.Account -> AccountScreen(
                        ...
                        worker = true,
                        // ══════════════════════════════════════════
                        // **وقسمُ الإشعارات صار له معنى**
                        // ══════════════════════════════════════════
                        //
                        // **كان مطفأً بحقّ**: النقطةُ لم تكن تُسجَّل
                        // لهذا التطبيق، **وقسمُ فحصٍ يقول «لا جهازَ
                        // مسجَّل» يُقرأ عطباً وهو ليس بعطب.**
                        //
                        // **وأُصلح التسجيلُ مركزيّاً** ٢٠٢٦-٠٨-٢٩
                        // (`Push.register` في `AppFrame` عند ثبوت
                        // الجلسة) — **فصار المندوبُ يُسجَّل كغيره.**
                        //
                        // **وطفأةٌ بقيت بعد زوال سببها تكذب** — تقول
