...
data class IncentivesPayload(
    ...
    /**
     * **مراحلُ الشهر الثلاث** — (قرارُ المالك ٢٠٢٦-٠٨-٣١).
     *
     * **والمطفأةُ لا تصل أصلاً** — المحرّكُ يرشّحها، **فما وصل يُعرض.**
     *
     * **وفارغةٌ تعني نسخةَ محرّكٍ لا تعرفها** — فتُعرض المرحلةُ الواحدةُ
     * كما كانت. **وشاشةٌ تسقط لأنّ حقلاً غاب أسوأُ من شاشةٍ ناقصة.**
     */
    val levels: List<TargetLevel> = emptyList(),
)

/** **مرحلةٌ من مراحل الشهر** — رقمُها وعددُها ومكافأتُها. */
@Serializable
