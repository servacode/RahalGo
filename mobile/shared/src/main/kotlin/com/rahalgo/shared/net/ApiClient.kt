...
class ApiClient(
    ...
    @PublishedApi internal val json = Json {
        ...
        explicitNulls = false
        // ══════════════════════════════════════════════════════════════
        // **و`null` صريحةٌ ليست حقلاً ناقصاً** (قِيس ٢٠٢٦-٠٩-١٦)
        // ══════════════════════════════════════════════════════════════
        //
        // **و`explicitNulls` تحكم الكتابةَ لا القراءة** — **فحقلٌ
        // يصل `null` ونوعُه في النموذج غيرُ قابلٍ للعدم يُسقط الفكَّ
        // كلَّه**، **ولو كانت له قيمةٌ افتراضيّة.**
        //
        // **وقِيس على المحاكي**: **`/public/platform` يردّ
        // `"logo": null` و`"auth_bg": null`** — **فسقطت قراءةُ حال
        // المنصّة في تطبيق السائق**: `تعذّرت قراءة حال المنصّة`.
        // **وذاك يقع كلّما لم تُرفع صورةٌ بعد** — **وهي حالُ منصّةٍ
        // جديدةٍ أو صورةٍ حُذفت.**
        //
        // **وهو عينُ ما أراده السطرُ الذي فوقه** — **«لا يُسقط الفكّ»**:
        // **فيُكمَل العقدُ هنا.**
