...
data class Quote(
    ...
    /**
     * **مُغطّاةٌ جغرافيّاً وخارجَ وقتها** (`ZH`، ٢٠٢٦-٠٩-١٤).
     *
     * **وهي غيرُ `outOfZone` بقصد** — **وعنوانٌ في قلب الحيّ المخدوم
     * ليس خارجَ التغطية، والساعةُ هي المانع.** **ومن خلطهما أخبر
     * زبوناً أنّ المنصّةَ لا تصله أبداً وهي تصله كلَّ صباح.**
     *
     * **والرسمُ يبقى معروضاً** — فالعنوانُ مُغطّىً والرقمُ صحيح.
     */
    @SerialName("zone_closed") val zoneClosed: Boolean = false,
    /**
     * **متى يُقبَل طلبٌ إلى هذا العنوان** — RFC 3339، وفارغٌ يعني
     * «لا موعدَ معلوم».
     *
