...
data class OrderRef(
    ...
    /**
     * ══════════════════════════════════════════════════════════════════
     * **رقمُ الطلب — واحدٌ يراه الجميع**
     * ══════════════════════════════════════════════════════════════════
     *
     * (شكوى المالك ٢٠٢٦-٠٨-١٨: «يجب أن يكون رقمُ الطلب مطابقاً لرقم
     *  الطلب الذي يظهر عند الزبون والسائق ولوحة الأدمن والمتجر
     *  والمندوب».)
     *
     * **وكان الحقلُ `code` — ولا وجودَ له في ردّ المحرّك**: `Order`
     * تحمل `number` ولا تحمل `code`. **فيُفكّ فارغاً** فتسقط الشاشةُ
     * إلى أوّل ستّة أحرفٍ من المعرّف — **رقمٌ لا يعرفه أحدٌ غيرُه.**
     *
     * **وحقلٌ لا وجودَ له لا يُسقط الفكّ** (`ignoreUnknownKeys` وقيمةٌ
     * افتراضيّة) — **فمرّ صامتاً حتّى شكا صاحبُه.**
     */
    val number: Long = 0,
    val status: String = "",
)
