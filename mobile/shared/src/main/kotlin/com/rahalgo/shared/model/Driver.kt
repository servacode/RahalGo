...
data class TrackPoint(
    ...
    /**
     * ══════════════════════════════════════════════════════════════════
     * **أقالها الجهازُ أم قالها تطبيقُ تزييف؟**
     * ══════════════════════════════════════════════════════════════════
     *
     * **(قِيس ٢٠٢٦-٠٩-٠٢: لا سطرَ في المنصّة كلِّها يفحص التزييف.)**
     *
     * **وتطبيقاتُ تزييف الموقع مجّانيّةٌ في المتجر** — يضع السائقُ
     * موضعَه عند بيت الزبون وهو في بيته، ثمّ يضغط «تمّ التسليم».
     *
     * **وإثباتُ التسليم يكتب «على بعد خمسةِ أمتار»** محسوبةً من
     * الموضع المزيَّف نفسِه — **فالحارسُ يشهد لمن يخدعه.**
     *
     * **وأندرويد يقولها بنفسه** — `isFromMockProvider`. **فمن لم
     * يُخدع بذكاءٍ بل بسؤالٍ لم يسأله.**
     */
    val mocked: Boolean? = null,
    /**
     * ══════════════════════════════════════════════════════════════════
     * **واتّجاهُ السير — درجةٌ من الشمال**
     * ══════════════════════════════════════════════════════════════════
     *
     * (المرحلة ١ من الملاحة، تصحيحُ المالك ٢٠٢٦-٠٨-٢٠: «أيّ نقاط
     *  تُجمع أثناء انقطاع الشبكة تفقد الاتجاه نهائيًا».)
     *
     * **وفارغٌ يعني «لم يقله الجهاز»** — لا شمالاً. **ومن قرأ الصفرَ
     * حين يغيب وجّه الدرّاجةَ شمالاً وهي تسير جنوبا.**
     *
     * **وله افتراضٌ فارغ**: طابورُ نقاطٍ كُتب على القرص قبل هذا الحقل
     * **يُقرأ كما هو ولا ينكسر** — والحقلُ الغائبُ يأخذ افتراضَه.
     */
