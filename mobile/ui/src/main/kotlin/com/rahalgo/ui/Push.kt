...
object Push {
     ...
     *
     * **ويُقرأ عند الخروج ليُرسَل مع النداء** — **فيُنهي المحرّكُ
     * وجهةَ الدفع مع الجلسة في معاملةٍ واحدة.**
     *
     * **وتعثّرُه لا يمنع الخروج**: **زرُّ خروجٍ لا يعمل أسوأُ من
     * وجهةٍ تبقى حتّى تموت بالزمن.**
     */
