...
private fun DangerSection(vm: AccountViewModel, s: AccountState) {
    ...
    if (!s.deleteAsked) {
        ...
        // ══════════════════════════════════════════════════════════════
        // **والرسالةُ قبل الرجوع لا بعده**
        // ══════════════════════════════════════════════════════════════
        //
        // (شكوى المالك ٢٠٢٦-٠٨-١٨: «أرسل رمزاً لحذف حسابي لا يعمل».)
        //
        // **وكان يعمل** — المحرّكُ يردّ سبباً صحيحاً («لديك طلبٌ جارٍ»)،
        // **والشاشةُ لا ترسمه**: نُقلت الرسائلُ إلى مواضعها في اليوم
        // نفسِه، **ووُضعت رسالةُ الخطر بعد `return` هذا** — أي في الحال
        // التي لا تقع إلّا بعد أن يصل الرمز.
        //
        // **فصار الزرُّ يُضغط ولا يقع شيءٌ ظاهر** — ولا خطأَ في سجلٍّ
        // ولا في شاشة. **وفعلٌ يُرفض بصمتٍ يُقرأ عطباً في التطبيق.**
