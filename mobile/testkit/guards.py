...
ALLOW = {
    u"لا لفظَ مكرّرٌ بين تطبيقين": {
        # **لفظٌ واحدٌ بمعنيين — ولا يُوحَّد**
        #
        # «استلمت الطلب» عند **السائق** تعني أخذ الطعامَ من المطعم،
        # وعند **المتجر** تعني قبولَ طلبِ الزبون (قرارُ المالك
        # ٢٠٢٦-٠٨-٢٩: «يكون استلمت الطلب أو رفض غير متوفر»).
        #
        # **وتوحيدُهما يربط معنيين بسلسلةٍ واحدة** — فمن صحّح لفظَ
        # السائق بدّل معنى المتجر. **والحارسُ يمسك التكرارَ ولا يعرف
        # المعنى**، فيُقال له هنا.
        u"driver·merchant": u"«استلمت الطلب»: أخذُ الطعام عند السائق · قبولُ الطلب عند المتجر.",
    },
