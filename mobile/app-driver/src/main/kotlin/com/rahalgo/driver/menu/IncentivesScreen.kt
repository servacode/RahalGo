...
import com.rahalgo.driver.ui.KeyValue
 ...
 */
@Composable
fun IncentivesScreen(vm: SectionsViewModel) {
    val data = vm.incentives
    if (data == null) {
        LoadState(vm.busy, vm.error) { vm.open(MenuItem.Rewards, force = true) }
        return
    }
