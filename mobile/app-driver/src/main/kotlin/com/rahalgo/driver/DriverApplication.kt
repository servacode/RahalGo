...
class DriverApplication : Application() {
    ...
    override fun onCreate() {
        ...
        MapStyleRepository.init(
            this,
                // **والثقبُ مشروطٌ بشرطين معاً**: بناءٌ تجريبيّ،
                // **وعنوانٌ حلقيٌّ فعلاً** (`MapConfig.isLoopbackHttp`).
                // فالإصدارُ يمرّ بـ`false` دائماً — **ولا سبيلَ إلى
                // فتحه بخاصّيّةٍ ولا بمتغيّرِ بيئة.**
            MapConfig(
                baseUrl = Backend.MAPS_BASE_URL,
