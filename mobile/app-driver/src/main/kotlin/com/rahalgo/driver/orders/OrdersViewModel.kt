...
class OrdersViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private companion object {
        // ══════════════════════════════════════════════════════════════
        // **حدّ «وصلت» — خمسةٌ وعشرون مترا**
        // ══════════════════════════════════════════════════════════════
        //
        // (تصحيح المالك ٢٠٢٦-٠٨-١٢: «ثمانون متراً كثيرٌ جدّا».)
        //
        // **وثمانون شارعٌ كامل** — يقف على إشارةٍ قربَ المتجر فيُعدّ
        // واصلا، **ووقتُ الوصول يدخل في حساب التأخّر.**
        //
        // # ولماذا لا خمسةٌ ولا عشرة
        //
        // **دقّةُ الـGPS في هاتفٍ بمدينةٍ خمسةَ عشرَ متراً في أحسن
        // حالاتها**، وتسوء بين البنايات إلى ثلاثين. **وحدٌّ بخمسةٍ لا
        // يقع أبدا** — فيقف السائقُ ينتظر إعلاناً لا يأتي ثمّ يضغط
        // بيده، **وميزةٌ لا تعمل أسوأُ من ميزةٍ لا توجد.**
        //
        // **والوقوفُ ثلاثين ثانيةً هو الحارسُ الحقيقيّ** لا المسافة:
        // **من مرّ لا يقف**، ومن وقف عند الباب وقف.
        const val ARRIVAL_M = 25f
