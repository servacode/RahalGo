...
class OrdersViewModel(app: Application) : AndroidViewModel(app) {
    ...
    fun accept(orderId: String) {
        ...
        viewModelScope.launch {
            ...
            startTrip = true
            // ══════════════════════════════════════════════════════════
            // **والملاحةُ تبدأ من نفسها — لا تنتظر زرّا**
            // ══════════════════════════════════════════════════════════
            //
            // **(بلاغُ المالك ٢٠٢٦-٠٩-٠٢:** «زرُّ اتبعني لم أعرف ما
            // فائدتُه إلى الآن، لم أرَ فائدةً واضحةً له».)
            //
            // **وفائدتُه أنّه الملاحةُ نفسُها**: بلا ضغطه **لا صوتَ ولا
            // تقدّمَ في المسار، ولا يعرف التطبيقُ أنّك تحرّكت.**
            //
            // **والخريطةُ تُرى وتُحرَّك بدونه** — فيظنّ صاحبُها أنّ كلَّ
            // شيءٍ يعمل. **وزرٌّ لا يُعرف أثرُه لا يُضغط.**
            //
            // **وسائقٌ ينسى أن يضغطه يفقد الصوتَ كلَّه ولا يعرف لماذا**
            // — فيبدأ عند القبول، **ويبقى الزرُّ لإيقافه لمن أراد.**
            follow(true)
        }
    }
    ...
    fun follow(on: Boolean) {
        ...
        // ══════════════════════════════════════════════════════════════
        // **ويُقال إنّه بدأ — لا يُضاء وحسب**
        // ══════════════════════════════════════════════════════════════
        //
        // **(بلاغُ المالك ٢٠٢٦-٠٩-٠٢:** «لم أرَ فائدةً واضحةً له».)
        //
        // **وكان يُضاء الزرُّ ولا شيءَ سواه** — **ومن لم يلحظ الإضاءةَ
        // ظنّه بلا أثر.** وسائقٌ يقود لا يفحص ألوانَ الأزرار.
        //
        // **والإيقافُ يُقال أيضاً** — **ومن أطفأ الصوتَ سهواً يبحث عن
        // عطبٍ ليس في التطبيق.**
        val app = getApplication<Application>()
        com.rahalgo.ui.Flash.ok(
            app.getString(if (on) R.string.nav_started else R.string.nav_stopped),
        )
    }
