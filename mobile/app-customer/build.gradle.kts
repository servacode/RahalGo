...
android {
    ...
    defaultConfig {
        ...
        // ══════════════════════════════════════════════════════════════
        //
        // **ورقمٌ رُفع لا يُعاد**: 11 كان في مسار بلاي (بيانُ المالك
        // ٢٠٢٦-٠٩-١٤) — **وبلاي يرفض عند الباب بلا رسالةٍ تقول «زد
        // الرقم».**
        //
        // **والاسمُ رفعةٌ صغرى لا إصلاحُ عيب**: هذه النسخةُ تحمل سلوكاً
        // جديداً يراه الناس — **هويّةَ هاتفٍ سوريّةً · وأبوابَ وضعِ
        // إطلاقٍ · وحالاتٍ فارغةً مكتوبةً · وأربعةَ أحوالِ حدِّ توصيلٍ
        // مفترقةً · وقيدَ كلمةٍ مؤقّتة** — **فليست ترقيعاً.**
        versionCode = 12
        versionName = "1.1.0"
    }
