...
| **D7** | سقفُ النقد يقيس المحصَّل لا المكشوف | `NO_REGRESSION_TEST_YET` | — |
...
| **D14** | handleWS لا يفحص ActiveStatus | `NO_REGRESSION_TEST_YET` | — |
...
- F-08 (قبولُ السائق) — لا اختبارَ مرتبطٌ به
...
- F-25 (قيدٌ يدويٌّ في محفظة) — لا اختبارَ مرتبطٌ به
- … و33 أخرى
