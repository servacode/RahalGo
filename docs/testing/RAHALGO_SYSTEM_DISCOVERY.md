...
>
> **هذه أوّلُ جولةِ كشف، وأرقامُها مُتجاوَزةٌ كلُّها.**
>
> **ولا يُقرأ منها رقمٌ للاعتماد** — الحقيقةُ النهائيّةُ في
> [`DISCOVERY_COMPLETENESS_AUDIT.md`](DISCOVERY_COMPLETENESS_AUDIT.md)
> تحت `CURRENT CANONICAL DISCOVERY STATUS`.
>
> **وهذه أرقامُها الخاطئةُ وما صحّحها:**
>
> | فيها | الصواب |
> |---|---|
> | ٢٨٤ مساراً | **٢٩١** |
> | ٧٧ جدولاً | **٧٥** (شمل منظرَي PostGIS) |
> | ١٩ جدولَ واتساب | **١٧** |
> | ٣٨ انتقالاً | **٥٥** |
> | «عرضٌ بمهلةٍ أو سباق» | **سباقٌ وحدَه** — `queue` في الإنتاج |
> | «بوّابةُ انتقالٍ واحدة» | **`rotation.go` يلتفّ عليها** |
> | «١٩ مكوّناً ميّتاً في الويب» | **حيّةٌ كلُّها** |
>
> **وتبقى لقيمتها الوصفيّة**: خريطةُ النظام والحاويات والتكاملات
> **صحيحةٌ كما هي.**
