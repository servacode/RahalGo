...
- **SM-A525F disconnected (UI fidelity):** the remaining 26 UI-flow cases need the real device (wireless dropped; needs physical re-enable) — the emulator is too flaky for their multi-step navigation:
