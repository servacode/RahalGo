...
**Status now (2026-09-21 — authoritative row-level count; Batch-2 in progress):** `NOT_TESTED` 292 · `NOT_APPLICABLE` 8 · `PASS` 202 · `FAIL` 2 · `BLOCKED` 74. **Open mandatory rows: 368** (NOT_TESTED 292 + BLOCKED 74 + FAIL 2). Executed groups: CUST-00…CUST-12. FAILs (2): CUST-06-027→forced-password-change (P2, → CUST-DEF-010 in progress), CUST-09-026→CUST-DEF-008 (P3). Batch-2 CLOSED: CUST-03-003→CUST-DEF-006 (PASS), CUST-06-032→CUST-DEF-007 (PASS). Counted directly from the master's case-row status cells.
...
| 17 | CUST-06 | 32 | 22 | 10 | 0 | 0 | 17 | 1 | 14 |
...
| | **Total** | **578** | **474** | **104** | **292** | **8** | **202** | **2** | **74** |
