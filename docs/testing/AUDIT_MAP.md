...
## ٠ · المقاماتُ النهائيّة

```
SENSITIVE ACTIONS AUDIT-MAPPED    35/35   ✅
AUDITED                              29
NO-AUDIT WITH PROVEN REASON           5
...
**⚠️ والواحدةُ الشاذّة**: **`PATCH /merchant/stores/{id}/settings`** —
**بلا تدقيقٍ وبلا سببٍ مُثبَت.** فهي **`PROVEN RISK`** لا سلوكاً
مبرَّراً، **وقرارُها للمالك.**
