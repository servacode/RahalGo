...
--
-- **وإطفاؤها وحدَه يُعطّل الموقع**: الزبونُ يتصفّح **أقساماً لا متاجر**، فصفرُ
-- أقسامٍ صفرُ متجر — والرئيسيةُ تعرض فراغاً ولا سبيلَ إلى الطلب.
--
-- **وقع فعلاً** (٢٠٢٦-٠٨-٠٣): أُطفئت هنا، فقال الموقعُ «لا يوجد اتصال
-- بالإنترنت» **والخادمُ يردّ مئتين** — وذهب المالكُ يُعيد تشغيل المشروع كلَّه.
--
-- **فلا يُشغَّل هذا النصُّ وحدَه.** يليه `field-sections.sql` الذي يملؤها من
-- أصناف المتجر الباقي — **فيبقى المصدرُ واحداً ويبقى الموقعُ يعمل.**
