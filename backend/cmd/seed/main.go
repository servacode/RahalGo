...
func main() {
	...
	storeOnly := flag.Bool("store", false, "زراعة متجرٍ واحد كامل وصاحبه — مطعمٌ بقائمةٍ حقيقية، ولا شيء غيره")
	flag.Parse()
	...
	// وضع المتجر: لا يمرّ بحسابات الزراعة ولا بالمناطق ولا بالمتاجر التجريبية
	if *storeOnly {
		seedStore(ctx, tx)
