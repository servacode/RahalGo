...
// Count **كم مشتركاً حيّاً الآن** — رقمٌ واحدٌ للمنصّة كلِّها.
//
// **ولا يُقسَّم على إنسان**: **المشتركُ هنا قناةُ بثٍّ لا هويّة**،
// **ومن قسّمه على المستخدم بنى تتبّعاً باسم الرصد.**
//
// **وهو عددُ الاشتراكات لا عددُ المقابس**: **مقبسٌ واحدٌ قد يشترك
// مرّتين** (غرفةُ العمل للمعلَّق) — **فيُقرأ كما هو مسمّى.**
