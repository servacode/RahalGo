...
// ══════════════════════════════════════════════════════════════════════
// **handlePushTest — يرسل رسالةَ فحصٍ ويقول ما وقع**
// ══════════════════════════════════════════════════════════════════════
//
// (وقع ٢٠٢٦-٠٨-١٤ على جهازٍ حقيقيّ: **لم يرنّ.** والجهازُ مسجَّلٌ
//
//	والمفتاحُ مضبوطٌ والمشروعُ متطابق — **ولا شيءَ في المنصّة يقول أين
//	وقفت الرسالة**، فبقي التخمينُ وحدَه.)
//
// # ولماذا يُبنى بابٌ لا يُقرأ سجلّ
//
// **سجلُّ الاستضافة يُقرأ بفتح لوحتها والبحث فيه** — ومن لا يفعل ذلك
// كلَّ يومٍ **لا يعلم أنّ إشعاراتِه ماتت منذ أسبوع.**
//
...
// # وما يردّه
//
// **حالُ التهيئة · وكم جهازاً مسجَّلاً · وكم رسالةً قُبلت · ونصُّ ما
// قالته غوغل إن رفضت** — كما هو بلا تلطيف: «SENDER_ID_MISMATCH» كلمةٌ
// تُبحث فتُوجد، **و«تعذّر الإرسال» لا تُوجد.**
func (s *Server) handlePushTest(w http.ResponseWriter, r *http.Request) {
	httpx.JSON(w, http.StatusOK, s.push.Diagnose(r.Context(), userIDFrom(r)))
}
