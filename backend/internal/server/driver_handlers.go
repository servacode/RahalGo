...
const driverOrderSelect = `
	SELECT o.id, o.number, o.status,
	       ...
	       COALESCE(m.name, ''),
	       -- ══════════════════════════════════════════════════════════════
	       -- **ورقمٌ واحدٌ لا رقمان**
	       -- ══════════════════════════════════════════════════════════════
	       --
	       -- (قرارُ المالك ٢٠٢٦-٠٨-١٢: «ما يصير رقم الهاتف مختلف عن
	       --  واتساب، هيك تخرب الدنيا».)
	       --
	       -- **وكان يُقرأ رقمُ واتساب ثمّ رقمُ الهاتف** — ورقمان لشخصٍ
	       -- واحدٍ يفترقان: **يبدّل أحدَهما وينسى الآخر**، فيصله رمزُ
	       -- الدخول على رقمٍ ولا يصله إشعارُ طلبه.
	       --
	       -- **والعمودُ باقٍ في القاعدة ولا يُقرأ** — وحذفُ عمودٍ فيه
