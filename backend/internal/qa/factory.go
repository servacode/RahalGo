...
// Phone هاتفٌ حتميٌّ بصيغة المنصّة — **`+9639` وثمانيةُ أرقام.**
//
// ══════════════════════════════════════════════════════════════════════
// **ولماذا ثمانيةٌ لا عشرة** (٢٠٢٦-٠٩-١٣)
// ══════════════════════════════════════════════════════════════════════
//
// **وكان يملأ أقصى ما تسمح به E.164** — `+9639` وعشرةٌ = أربعةَ عشرَ
// رقماً. **وذاك رقمٌ صالحٌ في العالم وليس رقماً سوريّاً**: المحمولُ
// السوريُّ `+963` وتسعةٌ تبدأ بـ9.
//
// **ومُعامَلٌ لا يقبله المنتَجُ لا يقيس المنتَج** — **يقيس بابَ
// خلفيٍّ يتجاوزه.**
//
// **والمدى صار مئةَ مليون** — والأساسُ يُختار مرّةً لكلّ عمليّةٍ
// والعدّادُ يزيد عليه، **فلا تصادمَ داخل التشغيل الواحد أبداً.**
func (n *Namespace) Phone() string {
	v := (n.seed ^ (n.next() * 0x9E3779B97F4A7C15)) % 1e8
	return fmt.Sprintf("+9639%08d", v)
}
