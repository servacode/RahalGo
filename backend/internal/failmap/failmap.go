...
var All = []Flow{
	...
	},
	{
		...
		Flows: []string{"F-30"}, Where: Local, Result: DefectReproduced,
		Steps: []string{
		...
		Observed:       "حسابٌ بأدواره بلا كلمة مرور — والإعادةُ تُردّ phone_taken",
		UserVisible:    "خطأٌ — والهاتفُ صار محجوزاً",
		AdminVisible:   PartialV,
		Recovery:       "BLOCKED — الهاتفُ محجوزٌ بمستخدمٍ ناقصٍ ولا مسارَ إصلاح",
