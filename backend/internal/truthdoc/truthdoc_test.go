...
func TestTruthDocIsCurrent(t *testing.T) {
	...
	// ══════════════════════════════════════════════════════════════
	// **ونهايةُ السطر لا تُقارَن** — **وgit على ويندوز يكتب `CRLF`**
	// ══════════════════════════════════════════════════════════════
	//
	// **والمولِّدُ يكتب `LF`** — **وسحبٌ جديدٌ على ويندوز يكتب `CRLF`**:
	// **فيسقط الحارسُ على شجرةٍ سليمةٍ لم يتبدّل فيها حرفٌ واحد.**
	//
	// **وقِيس ٢٠٢٦-٠٩-١٦ في شجرةِ عملٍ جديدةٍ لبناء `P-8`**:
	// **المحتوى متطابقٌ حرفاً بحرف، والفرقُ ٨٣٣ بايتاً هي ٨٣٣ نهايةَ
	// سطر.** **ووثيقةٌ تُتَّهم بالشيخوخة وهي حيّةٌ تُفقد الثقةَ بالحارس.**
	//
	// **ولا يُضعَف الشرط**: **ما يُقارَن هو المحتوى** — **ونهايةُ
	// السطر شأنُ `git` لا شأنُ الحقيقة.**
