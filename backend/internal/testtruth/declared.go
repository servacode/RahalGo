...
var Gaps = []GapDecl{
	...
	{ID: "XG-41C", Title: "فحصا `PF-09` يسقطان في الحزمة الكاملة وينجحان وحدَهما",
		...
		Fixed: "**أُصلح في دورةِ ٣٤ — والسببُ مقيسٌ لا مُستنتَج.** " +
			...
			"**والإصلاحُ في المِسنَد**: `disownPendingPush` **تُطفئ " +
			"العلامةَ عن عملٍ خلّفه اختبارٌ انتهى** — **ولا منفّذَ " +
			"له في هذه العمليّة، فبقاؤه «معلَّقاً» هو الكذب.** " +
...
var TestMap = map[string]TestDecl{
	...
	"TestXG41C_InheritedPushQueueDoesNotStarveTheNextTest": queueIsolationTest(),
...
// queueIsolationTest حارسُ عزلِ صفّ الدفع بين الاختبارات — `XG-41C`.
//
// **يزرع ركاماً ⇒ يثبت الجوع ⇒ يبني مِسنَداً ⇒ يثبت أنّه لم يرثه.**
