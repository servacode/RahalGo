...
var Catalog = []Def{
	...
	// **نسبةُ المندوب من عمولة المنصة — لا من قيمة الطلب.**
	//
	// **حصّةٌ من حصّتنا**: ما يأخذه جزءٌ ممّا نكسبه، **لا زيادةٌ على المتجر**.
	// ونسبةٌ من قيمة الطلب تجعله يأخذ أكثرَ ممّا نأخذ في المتاجر منخفضةِ
	// العمولة — **فيربح المندوبُ ونخسر نحن على البيعة نفسِها.**
	//
	// **ودورُه جلبُ العميل**: يُقيَّد له عن كلّ طلبٍ يُسلَّم من متجرٍ جلبه هو.
	//
	// (قرارُ المالك ٢٠٢٦-٠٨-٠٤: «نسبةُ المندوب من المنصة».)
