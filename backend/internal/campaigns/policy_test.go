...
func TestValidDest(t *testing.T) {
	...
	bad := [][2]string{
		...
		// ══════════════════════════════════════════════════════════
		// **MD-02 · و«المتجر» لم تعد وجهةً** (قرارُ المالك ٢٠٢٦-٠٩-١٥)
		// ══════════════════════════════════════════════════════════
		//
		// **ولا شاشةَ متجرٍ عند الزبون** — **ووجهةٌ لا تُفتَح ليست
		// عقداً**: **وعدٌ يُرسَل في جيبه ولا يُوفى.**
		{"merchant", "8b0a8a71-d186-4647-ae3b-9cd3898508bf"},
		{"merchant", ""},
		{"MERCHANT", "x"},
		{"merchants", "x"},
		{"../../etc/passwd", "x"},
